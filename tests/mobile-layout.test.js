...
assert(indexSource.includes("app.js?v=20260817-2") && indexSource.includes("styles.css?v=20260817-2") && indexSource.includes("mobile-v2.css?v=20260817-1"), "手机订单编辑更新必须使用新的静态资源版本，避免手机继续命中旧缓存");
