...
assert(indexSource.includes("app.js?v=20260825-ai-quantity-1") && indexSource.includes("styles.css?v=20260825-ai-quantity-1") && indexSource.includes("mobile-v2.css?v=20260817-1"), "手机 AI 数量换算更新必须使用新的静态资源版本，避免手机继续命中旧缓存");
...
assert(stylesSource.includes(".edit-order-line.is-expanded label") && stylesSource.includes(".edit-order-mobile-summary"), "手机订单编辑必须默认折叠输入控件，仅展开当前商品");
