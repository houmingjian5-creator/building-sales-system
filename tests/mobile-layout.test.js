...
assert(indexSource.includes("app.js?v=20260903-receivables-1") && indexSource.includes("styles.css?v=20260903-receivables-1") && indexSource.includes("mobile-v2.css?v=20260817-1"), "手机端更新必须使用新的静态资源版本，避免继续命中旧缓存");
