...
const leadLabels = { unknown: "未判断", low: "低意向", medium: "中意向", high: "高意向", invalid: "无效", connected: "有效接通", no_answer: "未接", busy: "占线", do_not_call: "拒绝联系", other: "其他", claim: "领取", return: "退回", assign: "分配", recycle: "回收", manual_create: "手工新增", manual_claim: "手工领取", update_tag: "修改标签", update_resource: "修改资源资料", convert_customer: "转客户", update_customer: "更新客户", migrate_customer: "历史客户关联", unlink_customer: "解除客户关联", ready: "待导入", success: "成功", duplicate: "重复", raw: "未映射", processing: "处理中", preview: "已预览", mapping: "待映射", done: "完成" };
